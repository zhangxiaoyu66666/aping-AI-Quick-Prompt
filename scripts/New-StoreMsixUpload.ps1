param(
    ...
    [string]$PackageName = "60227Zhangxiaoyu.58211199A469F",
    [string]$Publisher = "CN=803DAEAD-9088-4EBE-9053-F30D1343DB20",
    [string]$PublisherDisplayName = "语过天秦研究所",
    [string]$DisplayName = "啊拼",
    [string]$Description = "啊拼 AI 快速提示词工作台。",
