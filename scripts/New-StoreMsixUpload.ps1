param(
    ...
    [string]$DisplayName = "$([char]0x554A)$([char]0x62FC)",
    [string]$Description = "A local-first Windows prompt workbench.",
...
try {
    ...
    $publishRoot = Join-Path $packageRoot "publish-$architecture"
